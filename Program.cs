...
");
                ...
                switch (opcao)
                {
                    ...
                    case "4":
                        ...
                        {
                            sw.WriteLine($"A Razao Social é: {novaPj.razaoSocial}");
                            sw.WriteLine($"O CNPJ é: {novaPj.cnpj}");
                            sw.WriteLine($"O rendimento é de: {novaPj.rendimento}");
                        }


                        using (StreamReader sr = new StreamReader($"{novaPj.razaoSocial}.txt"))
                        {
                            string linha; //= sr.ReadLine()
